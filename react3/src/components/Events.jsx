...
// 이벤트를 위한 속성는 JSX 문법에 의해서 카멜명명법으로 지정되어 있음
...
function Events() {
  ...
  return (
    <div>
      {/* button 태그에 inline 방식으로 click 이벤트 설정 */}
      ...
      <button type={'button'} className={'btn btn-primary'} onClick={() => alert('콜백함수로 화살표 함수를 사용하여 이벤트 처리')}>클릭
      </button>
