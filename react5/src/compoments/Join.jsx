      ...
      <div className={'row'}>
        <div className={'col-sm-4 mx-auto border border-3 border-primary rounded-3 p-3'}>
          ...
          <div className={'my-3'}>
            ...
            <input type={'text'} className={'form-control'} id={'user-name'} value={userName}
          ...
          <div className={'my-3'}>
            ...
            <input type={'text'} className={'form-control'} id={'user-phone'} value={userPhone}
                   onChange={handleUserPhone}/>
          </div>
          <div className={'my-3'}>
            <label htmlFor={'user-gender'} className={'form-label'}>USER GENDER : </label>
            <input type={'text'} className={'form-control'} id={'user-gender'} value={userGender}
